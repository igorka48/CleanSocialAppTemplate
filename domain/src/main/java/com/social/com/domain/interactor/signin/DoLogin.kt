...
import com.social.com.domain.repository.LoginRepository
 ...
 */
class DoLogin @Inject
internal constructor(val loginRepository: LoginRepository, threadExecutor: ThreadExecutor,
                     postExecutionThread: PostExecutionThread) : UseCase<LoginResponse, Void>(threadExecutor, postExecutionThread) {
    override fun buildUseCaseObservable(params: Void?): Observable<LoginResponse> {
