...
import com.social.com.view.ui.signup.SignupActivity
 ...
 */
@PerActivity
@Component(dependencies = arrayOf(ApplicationComponent::class), modules = arrayOf(ActivityModule::class, DataModule::class)) interface ActivityComponent {
